...
// Strips server-only fields (passwordHash, above all) before a user
// record is allowed to leave this service. Every method that hands a
// user back to a route must pass it through here first.
