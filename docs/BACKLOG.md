...
| US-08 | As a registered user, I want to request a password reset link via email, so that I can securely regain access to my account if I forget my credentials. | High | 5 | Backlog |
| US-09 | As a reader, I want to search and filter posts by specific tags, so that I can quickly discover content relevant to my interests. | Medium | 3 | Backlog |